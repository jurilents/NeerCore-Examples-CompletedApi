...
namespace SeniorTemplate.Infrastructure.Extensions;

public static class HttpContextExtensions
{
    /// <summary>Gets IP address from request headers.</summary>
    ...
    /// <summary>Gets user agent from request headers.</summary>
